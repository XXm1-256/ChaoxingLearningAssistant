...
- GitHub 公开源码：已通过 GitHub 插件同步到 main，功能源码提交为 `af05753bd11916d8625466977d7f636fdcf1e145`。
- GitHub Release 附件：当前插件仍没有创建 Release 或上传二进制附件接口；普通版 ZIP 已在本地完成结构和启动验证。
